...
export type TripUpdate = transit_realtime.TripUpdate;
export type Alert = transit_realtime.Alert

export type TranslatedString = transit_realtime.TranslatedString;
export type TimeRange = transit_realtime.TimeRange;
